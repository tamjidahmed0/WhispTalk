  ...
  return (
      ...
      <div className={`w-[7rem] max-lg:w-[5rem] max-md:w-[2rem]  bg-[f0f4fa] flex flex-col items-center py-4  ${darkMode === true ? 'bg-[#1E262F]' : 'bg-white'} `}>
        ...
        <div className={`space-y-4 ${darkMode === true ? 'text-white' : 'text-black'}`}>
          <div className="flex justify-center mt-10 mb-14 bg-[#5b96f7] rounded ">
          ...
          <Link href="/users" className={`flex justify-center px-3 py-4 rounded-full hover:scale-110 ${pathname === '/users' ? 'bg-[#5b96f7] text-white' : 'hover:bg-[#5b96f7] hover:text-white'}`}>
