    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className={`relative  text-black rounded-lg px-10 py-11 w-[30rem] ${darkMode === true ? "bg-[#1E262F]" : "bg-white"}`}>
        ...
        <div className={`w-full max-w-md mx-auto mt-10 p-6  `}>
          ...
          <label for="uploadFile1" className={`${darkMode === true && 'text-white'} flex bg-gray-800 hover:bg-gray-700  text-base px-5 py-3 outline-none rounded w-max cursor-pointer mx-auto font-[sans-serif]`}>
